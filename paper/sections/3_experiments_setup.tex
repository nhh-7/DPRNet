...
on a single CUDA GPU for a fixed LR input of $256{\times}256$ ($\times4$ output
$1024{\times}1024$), averaging over $100$ runs after $20$ warm-up runs. This input
...
comparable. To compare with FLOPs-based reports, the Multi-Adds values are multiplied
by two.
