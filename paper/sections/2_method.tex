...
design motivates DPR for four reasons. (i) The centers are driven by a
...
prototype confirmation are entangled, which weakens interpretability. DPR responds
by generating prototypes from the current tokens, decoupling
...
switch that defaults to the full model and reduces to its disabled
