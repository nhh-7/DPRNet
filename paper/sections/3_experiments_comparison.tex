...
prototype routing of DPR preserves CATANet-level
...
lightweight bracket. It uses fewer Multi-Adds than the lightweight Transformer baselines
SwinIR-light ($60.3$\,G) and SRFormer-light ($56.5$\,G) while delivering competitive
top-tier accuracy. Both its parameter count and Multi-Adds are modestly higher than CATANet's
($660$K/$52.14$\,G vs.\ $535$K/$46.8$\,G at $\times4$), reflecting the learnable query
bank and router projections of DPR, so no efficiency advantage over CATANet is claimed.
