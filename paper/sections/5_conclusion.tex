...
computation budget. The routing diagnostics provide mechanism-level evidence that the
...
initialization and a multi-seed variance study, completing the unified efficiency
comparison under a single measurement protocol, and extending DPR to larger training
