...
ablations (Sec.~\ref{sec:ablation}) train every variant over three seeds, which
...
so we frame the design elements as quality-preserving-to-positive and mutually compatible
rather than as large individual gains. The direct comparison against a re-implemented EMA
