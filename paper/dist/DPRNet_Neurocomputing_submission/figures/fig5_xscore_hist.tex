...
plotted block the distribution sits clearly to the right of its floor (block means
are about $1.5$--$2.1$ times $1/M$) yet stays far from $1$, confirming that the softmax
